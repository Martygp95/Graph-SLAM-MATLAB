...
factors{1+1} = struct(...
    ...
    'covariance', diag([3e-4,3e-4,(0.5*pi/180)*(0.5*pi/180)]),...
    'index',[0,1]);
...
factors{1+2} = struct(...
   'type' , 'motion',...
    ...
    'covariance', diag([3e-4,3e-4,(2*pi/180)*(2*pi/180)]),...
    'index',[1,2]);
...
factors{1+8} = struct(...
    ...
    'covariance', diag([3e-4;(10*pi/180)*(10*pi/180)]),...
    'index',[0,6]);
